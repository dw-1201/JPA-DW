...
public class QOrders extends EntityPathBase<Orders> {
    ...
    private static final long serialVersionUID = 2010889990L;
    ...
    public final com.example.dw.entity.user.QUsers user;
    ...
    public QOrders(Class<? extends Orders> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.dw.entity.user.QUsers(forProperty("user"), inits.get("user")) : null;
    }
