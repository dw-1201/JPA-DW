...
public class NoticeListDto {
    ...
    @QueryProjection
    public NoticeListDto(Long id, String noticeBoardTitle, String noticeBoardContent, Long noticeBoardViewCount, LocalDateTime noticeBoardRd, LocalDateTime noticeBoardMd) {
        this.id = id;
